...
M.set = function()
  ...
  vim.api.nvim_set_hl(0, "LspDiagnosticsSignError", { bg = "none" })
  vim.api.nvim_set_hl(0, "LspDiagnosticsSignWarning", { bg = "none" })
  vim.api.nvim_set_hl(0, "LspDiagnosticsSignHint", { bg = "none" })
  vim.api.nvim_set_hl(0, "LspDiagnosticsSignInformation", { bg = "none" })
